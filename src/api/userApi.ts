...
export const getFollowedPlaylists = async (offset: number, limit: number): Promise<Playlist[]> => {
  const res = await fetch(`/spotify/user/playlists/followed?offset=${offset}&limit=${limit}`);
...
export const getFollowedAuthors = async (offset: number, limit: number): Promise<Author[]> => {
  const res = await fetch(`/spotify/user/authors/followed?offset=${offset}&limit=${limit}`);
...
export const getFollowedAlbums = async (offset: number, limit: number): Promise<Playlist[]> => {
  const res = await fetch(`/spotify/user/albums/followed?offset=${offset}&limit=${limit}`);
